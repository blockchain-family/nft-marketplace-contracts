...
import "./modules/access/OwnableInternal.sol";
import "./modules/TIP4_royalty/TIP4_royaltyCollection.sol";

contract CollectionWithRoyalty is TIP4_royaltyCollection, TIP4_2Collection, TIP4_3Collection, IBurnableCollection, OwnableInternal {
	...
	function _buildNftState(TvmCell code, uint256 id)
		...
		pure
		virtual
		override (TIP4_1Collection, TIP4_2Collection, TIP4_3Collection)
		returns (TvmCell)
	{
