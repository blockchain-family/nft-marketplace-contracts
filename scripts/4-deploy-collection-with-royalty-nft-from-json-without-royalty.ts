...
async function main() {
  ...
  const data = fs.readFileSync("metadata-royalty-template2.json", "utf8");
  ...
  let royalty = {
    numerator: 10,
    denominator: 100,
    receiver: new Address("0:1cd111d3a06e9fcd2eff2847ba0f6e36ead43e9842df791d3621c0ef7619c570")
  } as Royalty;
